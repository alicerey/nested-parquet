...
from umbra.parquetview('sf10_11.parquet') first11, umbra.parquetview('sf10_8.parquet') first8, umbra.parquetview('sf10_11.parquet') last11, umbra.parquetview('sf10_8.parquet') last8
where first11._psk1 = first8._sk 
      ...
      and first11._sk = ( select min(b11._sk) 
                                        from umbra.parquetview('sf10_11.parquet') b11, umbra.parquetview('sf10_8.parquet') b8
