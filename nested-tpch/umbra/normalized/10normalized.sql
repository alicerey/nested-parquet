...
from
        umbra.parquetview('nestedregion_1.parquet') n
                inner join umbra.parquetview('nestedregion_2.parquet') c on n._sk = c._psk1
                inner join umbra.parquetview('nestedregion_3.parquet') o on c._sk = o._psk2
                inner join umbra.parquetview('nestedregion_4.parquet') l on o._sk = l._psk3
where
